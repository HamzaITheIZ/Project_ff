	...
	<div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="adminIndex.php" class="nav-link">Home</a></li>
                    <li class="nav-item"><a href="gestiondesplat.php" class="nav-link">Gestion des Plat</a></li>
	          <li class="nav-item"><a href="services.html" class="nav-link">Gestion des Commande</a></li>
                  <li class="nav-item"><a href="blog.html" class="nav-link">Gestion des  Laivreur &AMP; Véhicule</a>
                     <!--<div class="navbar-brand nav-content">
                        <ul>
                            <li><a href="#">Ajouter des plat</a></li>
                            <li><a href="#">Ajouter des Commande</a></li>
                        </ul>
                      </div>-->
                  </li>
