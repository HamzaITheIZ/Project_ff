...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
                ...
                <div class="container">
                    <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                        ...
                        <div class="col-md-7 col-sm-12 text-center ftco-animate">
                            <span class="subheading">Bienvenue Dans la Menu</span>
                            <h1 class="mb-4">Prends Ton Temps</h1>
                            <p class="mb-4 mb-md-5">Vous pouvez consulter le menu et demander à travers</p>
                            <p><a href="#Menu" class="btn btn-primary p-3 px-xl-4 py-xl-3">Voir La Menu</a></p>
                        </div>
        ...
        <section id="Menu" class="ftco-section ftco-menu" >
            <div class="container">
