...
<html lang="en">
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <section class="ftco-intro " style="background-color: black;">
                    ...
                    <div class="info mx-auto">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-4 d-flex ftco-animate">
                                ...
                                <div class="text">
                                    <h3>Marrakech</h3>
                                    <p>Avenue Mohammed V, Marrakech 40000</p>
                                </div>
                            </div>
                            <div class="col-md-4 d-flex ftco-animate">
                                <div class="icon"><span class="icon-clock-o"></span></div>
                                <div class="text">
                                    <h3>Ouvert du lundi au dimanche</h3>
                                    <p>9:00am - 11:00pm</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-7 heading-section ftco-animate text-center">
                        <h2 class="mb-4">Notre Employes</h2>
                        <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
                        <p class="mt-5">Nous avons des travailleurs efficaces qui comptent sur eux et tiennent à vous servir.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                        <div class="staff" style="border: none;">
                            <div class="img mb-4" style="background-image: url(images/emp1.jpg);"></div>
                            <div class="info text-center">
                                <h3><a href="teacher-single.html">Laila Idrissi</a></h3>
                                <span class="position">SERVANTE</span>
                                <div class="text">
                                    <p>
                    ...
                    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                        <div class="staff" style="border: none;">
                            <div class="img mb-4" style="background-image: url(images/emp4.jpg);"></div>
                            <div class="info text-center">
                                <h3><a href="teacher-single.html">Ahmed Ali</a></h3>
                                <span class="position">chef cuisinié</span>
                                <div class="text">
                                     <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
                                    </p>
                    ...
                    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                        <div class="staff" style="border: none;">
                            <div class="img mb-4" style="background-image: url(images/emp2.jpg);"></div>
                            <div class="info text-center">
                                <h3><a href="teacher-single.html">Houda Khaldi</a></h3>
                                <span class="position">chef cuisinié</span>
                                <div class="text">
                                     <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
                    ...
                    <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                        <div class="staff" style="border: none;">
                            <div class="img mb-4" style="background-image: url(images/emp3.jpg);"></div>
                            <div class="info text-center">
                                <h3><a href="teacher-single.html">Ibrahim Arfaoui</a></h3>
                                <span class="position">serveur</span>
                                <div class="text">
                                     <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
                                    </p>
